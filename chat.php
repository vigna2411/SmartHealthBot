...
<body>
  ...
  <div class="cont">
    <?php if(isset($_SESSION['full_name'])): ?>
      ...
      <button id="formButton" class="btn btn-light btn-lg" type="button" name="button"><a href="#form1" style="color:black;text-decoration: none;">Update Info</a></button>
      <button id="formButton" class="btn btn-light btn-lg" type="button" name="button"><a href="index1.php" style="color:black;text-decoration: none;">Book Appointment</a></button>
  
      <h1>Welcome <?php echo (string)$_SESSION['full_name'];?></h1>
    <?php endif ?>

  </div>
  <iframe  width="90%" height="80%" allow="microphone;" src="https://console.dialogflow.com/api-client/demo/embedded/254c68fa-50d9-43dc-a054-f229c7a6305b"></iframe>
